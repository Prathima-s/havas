...
const TopbarWrapper = styled.div`
  .isomorphicTopbar {
    ...
    padding: ${props =>
      props['data-rtl'] === 'rtl' ? '25px 155px 25px 20px' : '25px 20px 25px 155px'};
    z-index: 1000;
    ${transition()};

    .ant-dropdown .ant-dropdown-placement-bottomLeft ul li p {
    ...
    .isoImgText {
      ...
      .ant-select-focused .ant-select-selection, .ant-select-selection:focus, .ant-select-selection:active, .ant-select-selection, .ant-select-selection:hover {
